...
<xsl:output method="xml" doctype-system="http://www.w3.org/2002/04/xhtml-math-svg/xhtml-math-svg-flat.dtd" doctype-public="-//W3C//DTD XHTML 1.1 plus MathML 2.0 plus SVG 1.1//EN"/>
  ...
  <xsl:template match="atom:feed">
	...
	<meta name="robots" content="noindex,nofollow" />
        ...
        <link rel="shortcut icon" type="image/x-icon" href="images/mars.ico" />
      ...
      <body>
        ...
        <div id="sidebar">
          ...
          <dl>
            ...
            <dt>Powered by:</dt>
            <dd>
              <a href="http://github.com/rubys/mars/tree/master" title="Sam Ruby’s Mars">
                <img src="images/mars.png" width="80" height="15"
                  alt="Planet" />
              </a>
            </dd>
            <dt>Export:</dt>
